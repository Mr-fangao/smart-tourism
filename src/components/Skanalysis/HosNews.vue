<template>
  <div>
    <div class="container">
      <span class="newstitle">援助新闻</span>
...
<!--          <div style="text-align: center; font-size: 14px;">{{news.pubDate|f_time}}</div>-->
          <div style="text-align: center; font-size: 13px;">{{news.pubDate|f_time2}}</div>
        ...
        <div class="newsRight">
          ...
          <a :href="news.sourceUrl" target="__blank" style="font-size: 12px;line-height: 18px">{{news.summary}}</a>
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.$root._dataserver.loadHosNews(p).then(news => {
        this.newses = news;
      });
    }
  },
