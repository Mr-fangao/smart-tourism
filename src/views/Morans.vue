    ...
    <div>
      ...
      <div id="ToolContainer">
        <transition name="el-fade-in">
          <div class="TOOLC">
            <div class="Item">
              <!--              <el-tooltip class="item" content="IDW反距离加权插值" effect="dark" placement="right" :offset="35">-->
              <!--                <div class="Button1" @click="toIDW">-->
              <!--                  <i class="el-icon-map-location" id="ICON1"></i>-->
              <!--                  <i class="Title">插值</i>-->
              <!--                </div>-->
              <!--              </el-tooltip>-->
              <el-tooltip
              ...
              <!-- <router-link :to="{path:'/CityAnA'}" tag="div">
                <el-tooltip class="item" content="城市尺度分析" effect="dark" placement="right" :offset="35">
                  <div class="Button4" @click="toCity">
                    <i class="el-icon-user" id="ICON4"></i>
                    <i class="Title">城市</i>
                  </div>
                </el-tooltip>
              </router-link> -->
      ...
      <div id="mapTool1">
        <!-- <img class="IDWICON" src="../../../static/IMG/Analysis/IDW.png"> -->
        ...
        <div class="IDWtoolContainer">
          <div class="GVa" id="GetMapValue1">请求数据</div>
          <div id="AnaMapValue2">开始分析</div>
        </div>

        <div id="chartShow">
          <h1 class="IDWChartTitle">
            <span
              style="
                font-size: 40px;
                margin-right: 7px;
          ...
          <div id="ChinaData" v-show="ChinaDShow">
            <div style="color: rgba(247, 76, 49, 0.8)">
              确诊：<span
                style="color: rgba(247, 76, 49, 0.8); font-family: Orbitron"
                >{{ Q }}</span
              >
            </div>
            <div style="color: rgba(233, 199, 60, 0.8)">
              现有：<span
                style="color: rgba(233, 199, 60, 0.8); font-family: Orbitron"
                >{{ X }}</span
              >
            </div>
            <div style="color: rgba(40, 183, 163, 0.8)">
              治愈：<span
                style="color: rgba(40, 183, 163, 0.8); font-family: Orbitron"
                >{{ Z }}</span
              >
            </div>
            <div style="color: rgba(119, 140, 179, 0.8)">
              死亡：<span
                style="color: rgba(119, 140, 179, 0.8); font-family: Orbitron"
                >{{ S }}</span
              >
            </div>
          </div>
...
// import HosNews from "../../VisualPages/HosNews";
// import ChCity from "./ChCity";
 ...
 if ($(".timeH").html()) {
  ...
  methods: {
    getData: function () {
      ...
      axios
        .get(
          "https://lab.isaaclin.cn/nCoV/api/area?latest=1&province=%E4%B8%AD%E5%9B%BD"
        )
        .then((res) => {
    ...
    GetDataAPP: function () {
      ...
      axios
        .get(
          "https://api.tianapi.com/txapi/ncovcity/index?key=6848bf141edb09a1ebfd4162bc84c624"
        )
        .then((res) => {
          {
            for (var i = 0; i < 15; i++) {
    ...
    toCity: function () {
      ...
      $(".Button2").css("color", "#FFFFFF");
      $(".Button3").css("color", "#FFFFFF");
      $(".Button4").css("color", "#ef5b09");
      $("#mapTool1").css("display", "none");
      $("#mapTool2").css("display", "none");
      $("#mapTool3").css("display", "none");
      $("#mapTool4").css("display", "block");
    },
  },
  created() {},
};
